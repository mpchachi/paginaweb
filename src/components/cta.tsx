      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="md:grid md:grid-cols-[1.5fr_1fr] md:gap-12 md:items-center">
          ...
          <div className="mt-8 md:mt-0 md:text-right">
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-white/5 text-white font-medium px-7 py-3.5 rounded-lg transition-colors hover:bg-white/10 active:scale-[0.98]"
            >
              Join the pilot
              <svg
                className="w-4 h-4"
