  ...
  return (
    <div className="bg-neutral-900 p-8 md:p-14 rounded-3xl mb-4">
      ...
      <p className="text-cyan-400/80 text-sm font-medium">
        Key learning → The data matters, not the device capturing it.
      </p>
    </div>
  );
}
...
function HarvardContent() {
  return (
    <div className="bg-neutral-900 p-8 md:p-14 rounded-3xl mb-4">
      ...
      <p className="text-cyan-400/80 text-sm font-medium">
        Key learning → Clinical validation comes from the field, not the lab.
      </p>
    </div>
  );
}
  ...
  return (
    <div className="bg-neutral-900 p-8 md:p-14 rounded-3xl mb-4">
      ...
      <p className="text-white/50 text-sm md:text-base max-w-3xl leading-relaxed mb-6">
        ...
        and reaction time. The patient plays; the AI extracts clinical metrics. 
        Rehabilitation disguised as entertainment.
      </p>
      <p className="text-cyan-400/80 text-sm font-medium">
        Key learning → Patients engage more when therapy feels like a game.
      </p>
    </div>
  );
}
...
function DashboardContent() {
  return (
    <div className="bg-neutral-900 p-8 md:p-14 rounded-3xl mb-4">
      ...
      <p className="text-cyan-400/80 text-sm font-medium">
        Key learning → 100% software. Zero hardware. Maximum clinical insight.
      </p>
    </div>
  );
}
    ...
    <section id="demo" className="pt-32 pb-24 md:pt-40 md:pb-32">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="mb-4 animate-on-scroll">
          <p className="text-xs font-medium text-cyan-400 uppercase tracking-wider mb-3">
            Our journey
          </p>
