...
function GloveContent() {
  return (
    <div className="bg-slate-50 p-8 md:p-14 rounded-3xl mb-4">
      <p className="text-slate-700 text-base md:text-lg max-w-3xl leading-relaxed mb-6">
        It all started with a <span className="font-semibold text-slate-900">sensor glove</span> —
        a wearable device packed with flex sensors and an Arduino to capture finger
        movement data from post-stroke patients.
      </p>
      <p className="text-slate-500 text-sm md:text-base max-w-3xl leading-relaxed mb-6">
      ...
      <p className="text-slate-400 text-sm border-t border-slate-200 pt-4 mt-2">
...
function HarvardContent() {
  return (
    <div className="bg-slate-50 p-8 md:p-14 rounded-3xl mb-4">
      <p className="text-slate-700 text-base md:text-lg max-w-3xl leading-relaxed mb-6">
        We brought our vision to <span className="font-semibold text-slate-900">Harvard's Health Systems Innovation Lab</span> in
...
function GameContent() {
  return (
    <div className="bg-slate-50 p-8 md:p-14 rounded-3xl mb-4">
      <p className="text-slate-700 text-base md:text-lg max-w-3xl leading-relaxed mb-6">
        We built <span className="font-semibold text-slate-900">FisherGame</span> — a pixel-art
...
function DashboardContent() {
  return (
    <div className="bg-slate-50 p-8 md:p-14 rounded-3xl mb-4">
      <p className="text-slate-700 text-base md:text-lg max-w-3xl leading-relaxed mb-6">
        The <span className="font-semibold text-slate-900">Clinical Dashboard</span> brings it all together.
